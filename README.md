...
Sneaker project is a fully client-facing sneaker configurator built with the Next.js App Router. Authenticated designers can create, preview, and save sneaker colorways, while guests can still experiment with the tool and export high-fidelity PDFs of their work when authenticated.
...
[] Produkten ska vara optimerad och ha tillräckligt stora filfomrat,
återanvända kod och komponenter samt använda optimeringstekniker där det
behövs.
[] Implementera CRUD-operationer, Create, Read, Update, Delete, med säker
hantering av användardata.

[] Implementera en säker autentiseringslösning för databasen, till exempel OAuth,
...
[] Produkten ska vara fullt responsiv och anpassa sig dynamiskt till
...
[] Skriv en tydlig README som inte bara beskriver projektet och hur det körs, men
som också förklarar projektets tekniska val och hur olika funktioner
implementerats.

# Versionshantering:

[] Arbeta med feature branches och gör pull requests innan du mergar till
baskoden för att säkerställa ordning och spårbarhet.
[] Dokumentera varje steg i din commit-historik med tydliga och informativa
commit-meddelanden.

# Deploy:

[] Automatiserat flöde för bygge och deploy av applikationen, där byggprocessen
...
[] Förklara och motivera dina beslut inom UX/UI-design och tillgänglighet, och hur
dessa har förbättrat användarupplevelsen.

[] Helhetsupplevelsen: Applikationen ska, utöver att uppfylla G-kraven, erbjuda en
